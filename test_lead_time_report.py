...
class LeadTimeTests(unittest.TestCase):
    def test_compute_lead_times(self):
        ...
        self.assertAlmostEqual(res["1001"][0]["hours_in_business"], 4)
        self.assertAlmostEqual(res["1001"][1]["hours_in_business"], 2)
        self.assertAlmostEqual(res["1001"][0]["hours_after_hours"], 0)
    ...
    def test_compute_lead_times_show_breakdown_prints(self):
        ...
        self.assertIn("After hours: 0.00h", output)
        self.assertAlmostEqual(res["1001"][0]["hours_in_business"], 4)
        self.assertAlmostEqual(res["1001"][0]["hours_after_hours"], 0)
